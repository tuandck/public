...
<form role="search" method="get" class="bhdt-wire-search" action="<?php echo esc_url( bhdt_wirecutter_current_lang_home_url() ); ?>">
	...
	<input type="search" id="bhdt-search-field" class="bhdt-wire-search-input" placeholder="<?php echo esc_attr__( 'Tìm bài viết, hướng dẫn, linh kiện…', 'bhdt-wirecutter' ); ?>" value="<?php echo esc_attr( get_search_query() ); ?>" name="s" />
